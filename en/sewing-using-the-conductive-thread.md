...
2. If you are using a regular LED, you will need to bend the pins out into loops. A round-nosed pliers can be helpful here. If you have a sewable LED, skip this step!
